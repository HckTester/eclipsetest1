...
public class Final_TC8 extends Base{
	...
	@Test(priority = 8)
	public void Click_Learning() throws Exception {
		System.out.println("Learning section - Started");
		Home_Page Home = new Home_Page(driver, pr);
		Home.Click_Learning_Section();
		Thread.sleep(2000);
		System.out.println("Learning Section - Completed");
	}
